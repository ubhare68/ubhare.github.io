...
function get_header_html_text() {
	...
	if (kind == 'HTML') {
		...
		var sidePositionPanel = 'left',
			...
			//logo_style
			st_logo_font_color="#87b01a",
			st_logo_font_size="24",
			//headers_style
			h1_font_color="#fff",
			h1_font_size="24",
			h2_font_color="#717171",
			h2_font_size="14",
			h3_font_color="#717171",
			h3_font_size="14",
			// global style
			content_font_style="Arial",
			content_font_size="12",
			content_line_spacing='1.5', // em
			content_font_color="#b0b0b0",
			content_links_font_color="#87b01a",
			//background style
			background_color="#efefef",
			background_img="bg_p2_10.png",
